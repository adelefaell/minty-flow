...
interface CategoryTypeSelectorSheetProps {
  id: string
  onTypeSelected: (type: TransactionType) => void
  selectedType: TransactionType
}

const categoryTypesList: { type: TransactionType; label: string }[] = [
...
export const CategoryTypeSelectorSheet = memo(
  ({ id, onTypeSelected, selectedType }: CategoryTypeSelectorSheetProps) => {
